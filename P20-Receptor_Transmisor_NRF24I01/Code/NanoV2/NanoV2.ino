/*-------------------------------------------------------------------------------
  ...
  Arduino NANO y otro con una tarjeta PROMICRO, un LCD 1602 con una interfaz 
  I2C, un KEYPAD 4x4 y el Transceptor NRF24I01, en el cual se establecerá una 
...
// test constantly if there is new data  available to send
	if (nrf24.available())      // si hay informacion disponible
  {
    ...
    {
      lcd.setCursor(4 + despLCD,1); // renglon
