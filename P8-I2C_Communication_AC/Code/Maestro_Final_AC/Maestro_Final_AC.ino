/*-------------------------------------------------------------------------------
  Practica numero 08 - Comunicación I2C entre dos placas de desarrollo Con 
  malla de potencia (Master)
  ...
  transmite un mensaje que se vera reflejada en un Diodo LED y un foco de 
  corriente alterna, este posera una malla de potencia que aislará todo lo 
  relacionado a Arduino de la corriente alterna.
---------------------------------------------------------------------------------
  ...
  message will be transmitted, which will be reflected in an LED diode and an 
  alternating current bulb. The bulb will have a power grid that isolates 
  everything related to Arduino from the alternating current.
